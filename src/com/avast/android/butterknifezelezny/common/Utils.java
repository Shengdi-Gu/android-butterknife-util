...
public class Utils {
    ...
    public static ArrayList<Element> getIDsFromLayout(final PsiFile file, final ArrayList<Element> elements) {
        boolean useIdAsFieldName = "true".equals(Utils.getUseIdAsFieldName());
        ...
        file.accept(new XmlRecursiveElementVisitor() {
            ...
            public void visitElement(final PsiElement element) {
                ...
                if (element instanceof XmlTag) {
                    ...
                    try {
                        elements.add(new Element(name, value,useIdAsFieldName));
    ...
    public static String getUseIdAsFieldName() {
        return PropertiesComponent.getInstance().getValue(Settings.USE_ID_AS_FIELD_NAME, "true");
    }
